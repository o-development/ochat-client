...
const PrivacyPolicyContent: FunctionComponent = () => (
  <View>
    <Text style={textStyle} category="h1">
      Privacy Policy
    </Text>
    <Text style={textStyle}>
      Jackson Morgan built the Liqid Chat app as an Open Source app. This
      SERVICE is provided by Jackson Morgan at no cost and is intended for use
      as is.
    </Text>
    <Text style={textStyle}>
    ...
    <Text style={textStyle}>
      ...
      Terms and Conditions, which is accessible at Liqid Chat unless otherwise
    ...
    <Text style={textStyle}>
      ...
      not limited to Solid WebId, Chat URIs, and your Name. The information that
      I request will be retained on your device and on an external server.
    </Text>
    <View>
      <Text style={textStyle}>
      ...
      />
      <Link href="https://expo.io/privacy" content="Expo" />
    </View>
    <Text style={textStyle} category="h2">
      Log Data
    </Text>
    ...
    <Text style={textStyle}>To facilitate our Service;</Text>
    <Text style={textStyle}>To provide the Service on our behalf;</Text>
    <Text style={textStyle}>To perform Service-related services; or</Text>
    <Text style={textStyle}>
    ...
    <Text style={textStyle}>This policy is effective as of 2021-03-11</Text>
    <Text style={textStyle} category="h2">
      Contact Us
    </Text>
    <Text style={textStyle}>
      If you have any questions or suggestions about my Privacy Policy, do not
      hesitate to contact me at jackson@o.team.
    </Text>
  </View>
);
